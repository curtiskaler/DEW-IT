...
public sealed class StepAndResultCollection : List<StepAndResult>, IStepAndResultCollection
{
    ...
    public StepAndResult Get(Guid stepUUID)
    {
        ...
        if (result == null)
            throw new ArgumentOutOfRangeException(string.Format(ProcessingStrings.ERROR_Step_not_found, stepUUID));
        return result;
    }
    ...
    public StepAndResultCollection(IEnumerable<StepAndResult> stepsAndResults)
    {
        AddRange(stepsAndResults);
    }
}