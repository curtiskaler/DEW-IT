...
public abstract class Priority : Enumeration<Priority>
{
    ...
    public static Priority NOT_SPECIFIED => new Instance(0, nameof(NOT_SPECIFIED), "#C2C2C2" /* gray */);

    /// <summary> Minor issue or easily worked around. Color: blue </summary>
    public static Priority MINOR => new Instance(1, nameof(MINOR), "#0090FF" /* blueish */);

    /// <summary> Has the potential to affect progress. Color: yellow-green. </summary>
    public static Priority NORMAL => new Instance(2, nameof(NORMAL), "#00FF90" /* yellow-green */);

    /// <summary> Has the potential to block progress. Color: orange. </summary>
    public static Priority HIGH => new Instance(3, nameof(HIGH), "#FF9000" /* orange */);

    /// <summary> This will block progress. Color: a dark red. </summary>
    public static Priority CRITICAL => new Instance(4, nameof(CRITICAL), "#FF0000" /* red */);
