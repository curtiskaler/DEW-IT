...
#nullable disable
    ...
    /// <summary>
    /// Implicitly converts the given <see name="Enumeration"/> into its corresponding ordinal <see cref="int"/>.
    /// </summary>
    public static implicit operator int(Enumeration<E> enumeration) => enumeration.Ordinal;
}